...
const { getBlogs, detailBlogs, updateBlogs, saveBlogs, deleteBlogs, getBlogsPaginations, getBlogsPaginationOrders } = require('../controllers/BlogControllers');
...
router
    ...
    .get("/authors/pagination/", getBlogsPaginations) // Route per ottenere la paginazione dei blog
    .get("/authors/pagination/:order", getBlogsPaginationOrders) // Route per ottenere la paginazione dei blog
