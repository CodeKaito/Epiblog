...
const { getBlogs, getBlogsPaginations, getBlogsPaginationOrders, detailBlog, getPostsByAuthorName, saveBlog, updateBlog, deleteBlog  } = require('../controllers/BlogControllers');
...
router
    ...
    .get("/blogPosts/author/:name", getPostsByAuthorName)   // Route per ottenere tutti i post di un autore specifico
