...
const { getAuthors, getAuthorsPaginations, getAuthorsPaginationOrders, detailAuthor, updateAuthor, saveAuthor, deleteAuthor,  } = require('../controllers/AuthorControllers');
